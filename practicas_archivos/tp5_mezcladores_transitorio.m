...
% por el tiempo que tarda cada mezclador en alcanzar el 90%
% de la concentracion en el estado estacionario: t90.
%   1) Estime t90 para cada mezclador.
...
%   3) La carga en el mezclador 3 decrece en un 25% de forma abrupta en t=10min.
...
for i=1:N
  QCentr   = tp5_carga3_escalon(tt(i));
  bEsc3(i) = QCentr(3);
end
...
f3=@(c,t) (tp5_carga3_escalon(t) - A*c);
